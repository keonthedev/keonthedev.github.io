...
function App () {
  ...
  return <div id="drum-machine" className="min-vh-100 text-white inner-container">
...
function Pad ({clip, volume}) {
  ...
  return <div onClick={playSound} className={`btn btn-secondary p-4 m-3 ${active && "btn-warning"}`}>
